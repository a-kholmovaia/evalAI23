...
class LLMResponseHandler:
    def __init__(self, screen, context):
        ...
        self.waiting_for_response = False  # Indicates whether the system is waiting for a GPT response
...
Feedback: thank for the proveded response shortly, write 3-4 sentences what was good in the response and what needs improvement.
Refining Questions: _
"
Your Feedback:
"""
